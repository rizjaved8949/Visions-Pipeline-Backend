...
def load_config(
    *,
    ...
    cfg: dict[str, Any] = {
        ...
        "input": {
            "source": source or _env("GUARD_DEFAULT_SOURCE", "Guard_monotoring/local_data/guard/uploads/sample.mp4"),
            "max_frames": max_frames,
        },
        "output": {
            "directory": output_dir or _env("GUARD_OUTPUT_DIR", "Guard_monotoring/local_data/guard/outputs/manual-run"),
        ...
        "models": {
            ...
            "pose": {
                "weights": _env("GUARD_POSE_WEIGHTS", "yolo26m-pose.pt"),
            ...
            "phone": {
                "weights": _env("GUARD_PHONE_WEIGHTS", "yolo26m.pt"),
        ...
        "visualization": {
            ...
            "draw_panel": _bool("GUARD_DRAW_PANEL", True),
        },
        "modules": {
...
def runtime_paths() -> dict[str, Path]:
    upload_dir = Path(_env("GUARD_UPLOAD_DIR", "Guard_monotoring/local_data/guard/uploads"))
    output_dir = Path(_env("GUARD_OUTPUT_ROOT", "Guard_monotoring/local_data/guard/outputs"))
    db_path = Path(_env("GUARD_JOB_DB", "Guard_monotoring/local_data/guard/jobs.sqlite3"))
